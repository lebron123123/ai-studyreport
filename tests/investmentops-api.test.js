...
function db(){
  const state={projects:[{id:'project-ops',name:'[系统测试]运营',user_id:1,updated_at:10,data:JSON.stringify({project:{type:'rent'},workflow:{currentCalcSnapshotId:'calc-v1',calcSnapshots:[{id:'calc-v1',version:1,calcType:'rent',params:{rent:40},summary:result().summary}]}})}],project_memberships:[{project_id:'project-ops',user_id:2,role:'EDITOR',status:'active'},{project_id:'project-ops',user_id:3,role:'VIEWER',status:'active'}],project_artifacts:[{id:'evidence-1',project_id:'project-ops',user_id:1,artifact_type:'report',status:'confirmed',updated_at:0}],project_facts:[],project_meetings:[],project_tasks:[],project_risks:[],project_decisions:[],project_scenarios:[],project_events:[],project_evaluations:[],report_deliveries:[],project_decision_packages:[]};
