...
function surveyBrief(){
  ...
  if(project.populationText){
    out += "\n【人口数据（"+project.populationText+"）：需求分析/人口分析章节须引用此真实数据，不得编造其他人口数字】\n";
  }
  if(project.balanceText){
    out += "\n【职住平衡参考（"+project.balanceText+"）：仅为POI密度代理指标，非官方职住比，引用时须注明口径】\n";
  }
